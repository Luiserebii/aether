...
#ifdef CSTL_VECTOR_DECLARE_ONLY
#include <stdlib.h>
#else
#include <assert.h>
#include <stdlib.h>
...
#define declare_vector(prefix, suffix, struct_name, vector_type)                                        \
     ...
     */                                                                                                 \
    void prefix##init##suffix(struct struct_name* v);                                                          \
                                                                                                        \
    /*                                                                                                  \
     ...
     * is required.                                                                                     \
     */                                                                                                 \
    void prefix##init_size##suffix(struct struct_name* v, size_t s);                                           \
                                                                                                        \
    /*                                                                                                  \
     * Initializes an empty vector at vector* v with the size passed.                                   \
     * Unlike vector_init_size, this function will fill the capacity.                                   \
     */                                                                                                 \
    void prefix##init_capacity##suffix(struct struct_name* v, size_t s);                                       \
                                                                                                        \
    /*                                                                                                  \
     * Initializes a new vector v, and fills it with n elements, each with value val.                   \
     */                                                                                                 \
    void prefix##init_fill##suffix(struct struct_name* v, size_t n, vector_type val);                          \
                                                                                                        \
    /*                                                                                                  \
     * Initializes a new vector v, and fills it with the range [first, last) passed.                    \
     */                                                                                                 \
    void prefix##init_range##suffix(struct struct_name* v, const vector_type* first, const vector_type* last); \
                                                                                                        \
    /*                                                                                                  \
     ...
     */                                                                                                 \
    struct struct_name* prefix##create##suffix(void);                                                          \
                                                                                                        \
    /*                                                                                                  \
     ...
     * is required.                                                                                     \
     */                                                                                                 \
    struct struct_name* prefix##create_size##suffix(size_t s);                                                 \
                                                                                                        \
    /*                                                                                                  \
     * Creates an empty vector with the size passed.                                                    \
     * Unlike vector_create_size, this function will fill the capacity.                                 \
     */                                                                                                 \
    struct struct_name* prefix##create_capacity##suffix(size_t s);                                             \
                                                                                                        \
    /*                                                                                                  \
     * Creates a new vector, and fills it with n elements, each with value val.                         \
     */                                                                                                 \
    struct struct_name* prefix##create_fill##suffix(size_t n, vector_type val);                                \
                                                                                                        \
    /*                                                                                                  \
     * Creates a new vector, and fills it with the range [first, last) passed.                          \
     */                                                                                                 \
    struct struct_name* prefix##create_range##suffix(const vector_type* first, const vector_type* last);       \
                                                                                                        \
    /*                                                                                                  \
     ...
     */                                                                                                 \
    struct struct_name* prefix##copy##suffix(const struct struct_name* src);                                          \
                                                                                                        \
    /*                                                                                                  \
     ...
     * if needed.                                                                                       \
     */                                                                                                 \
    void prefix##asn##suffix(struct struct_name* dest, const struct struct_name* src);                                \
                                                                                                        \
    /*                                                                                                  \
     ...
     * if needed.                                                                                       \
     */                                                                                                 \
    void prefix##assign##suffix(struct struct_name* v, const vector_type* first, const vector_type* last);     \
                                                                                                        \
    /*                                                                                                  \
     * Sets an element of the vector to the value passed.                                               \
     */                                                                                                 \
    void prefix##set##suffix(struct struct_name* v, size_t pos, vector_type val);                              \
                                                                                                        \
    /*                                                                                                  \
     * Pushes a new element onto the vector.                                                            \
     */                                                                                                 \
    void prefix##push_back##suffix(struct struct_name* v, vector_type e);                                      \
                                                                                                        \
    /*                                                                                                  \
     ...
     */                                                                                                 \
    void prefix##push_back_r##suffix(struct struct_name* v, const vector_type* e);                             \
                                                                                                        \
    /*                                                                                                  \
     * Inserts a new element before the pointer passed.                                                 \
     */                                                                                                 \
    void prefix##insert##suffix(struct struct_name* v, vector_type* p, vector_type val);                       \
                                                                                                        \
    /*                                                                                                  \
     ...
     * performed by insert.                                                                             \
     */                                                                                                 \
    void prefix##insert_r##suffix(struct struct_name* v, vector_type* p, const vector_type* val);              \
                                                                                                        \
    /*                                                                                                  \
     * Inserts the range of values in [first, last), before the pointer passed.                         \
     */                                                                                                 \
    void prefix##insert_range##suffix(struct struct_name* v, vector_type* p, const vector_type* begin,         \
     ...
     */                                                                                                 \
    void prefix##pop_back##suffix(struct struct_name* v);                                                      \
                                                                                                        \
    /*                                                                                                  \
     * Erases an element at the pointer passed from the vector. Returns a pointer to the                \
     * new end of the vector.                                                                           \
     */                                                                                                 \
    vector_type* prefix##erase##suffix(struct struct_name* v, vector_type* pos);                               \
                                                                                                        \
    /*                                                                                                  \
     * Erases a range of elements [begin, end) from the vector. Returns a pointer to the                \
     * new end of the vector.                                                                           \
     */                                                                                                 \
    vector_type* prefix##erase_range##suffix(struct struct_name* v, vector_type* begin, vector_type* end);     \
                                                                                                        \
    /*                                                                                                  \
     * Returns the first pointer in the vector's sequence.                                              \
     */                                                                                                 \
    vector_type* prefix##begin##suffix(const struct struct_name* v);                                           \
                                                                                                        \
    /*                                                                                                  \
     * Returns the last pointer in the vector's sequence.                                               \
     */                                                                                                 \
    vector_type* prefix##end##suffix(const struct struct_name* v);                                             \
                                                                                                        \
    /*                                                                                                  \
     * Returns the current size of the vector.                                                          \
     */                                                                                                 \
    size_t prefix##size##suffix(const struct struct_name* v);                                                  \
                                                                                                        \
    /*                                                                                                  \
     * Returns the current total capacity of the vector,                                                \
     * which encompasses the total amount allocated.                                                    \
     */                                                                                                 \
    size_t prefix##capacity##suffix(const struct struct_name* v);                                              \
                                                                                                        \
    /*                                                                                                  \
     * Returns the element found at the specified location passed.                                      \
     */                                                                                                 \
    vector_type prefix##at##suffix(const struct struct_name* v, size_t n);                                     \
                                                                                                        \
    /*                                                                                                  \
     ...
     */                                                                                                 \
    void prefix##resize##suffix(struct struct_name* v, size_t n);                                              \
                                                                                                        \
    /*                                                                                                  \
     ...
     */                                                                                                 \
    void prefix##grow##suffix(struct struct_name* v, size_t n);                                                \
                                                                                                        \
    /*                                                                                                  \
     ...
     */                                                                                                 \
    void prefix##shrink##suffix(struct struct_name* v, size_t n);                                              \
                                                                                                        \
    /*                                                                                                  \
     ...
     */                                                                                                 \
    void prefix##destroy##suffix(struct struct_name* v);
...
#define define_vector(prefix, suffix, struct_name, vector_type)                                          \
     ...
     */                                                                                                  \
    static void prefix##autogrow##suffix(struct struct_name* v);                                                \
                                                                                                         \
    void prefix##init##suffix(struct struct_name* v) { CSTL_VECTOR_INIT(v); }                                   \
                                                                                                         \
    void prefix##init_size##suffix(struct struct_name* v, size_t s) {                                           \
    ...
    struct struct_name* prefix##create##suffix(void) {                                                          \
        ...
        struct struct_name* v = cstl_malloc(sizeof(struct struct_name));                                \
    ...
    struct struct_name* prefix##create_capacity##suffix(size_t s) {                                             \
        ...
        return v;                                                                                        \
                                                                                                         ...
                                                                                                         \
    struct struct_name* prefix##create_fill##suffix(size_t n, vector_type val) {                                \
        struct struct_name* v = prefix##create_size##suffix(n);                                                 \
        prefix##init_fill##suffix(v, n, val);                                                            \
        return v;                                                                                        \
    }                                                                                                    \
                                                                                                         \
    struct struct_name* prefix##create_range##suffix(const vector_type* first, const vector_type* last) {       \
        struct struct_name* v = prefix##create_size##suffix(last - first);                                      \
    ...
    struct struct_name* prefix##copy##suffix(const struct struct_name* src) {                                          \
        ...
        struct struct_name* copy = prefix##create_size##suffix(prefix##size##suffix(src));                      \
        /* Copy over values */                                                                           \
    ...
    void prefix##assign##suffix(struct struct_name* v, const vector_type* first, const vector_type* last) {     \
        ...
        v->avail = v->head + sz;                                                                         \
                                                                                                         ...
                                                                                                         \
    void prefix##set##suffix(struct struct_name* v, size_t pos, vector_type val) { v->head[pos] = val; }        \
                                                                                                         \
    void prefix##push_back##suffix(struct struct_name* v, vector_type e) {                                      \
        if(v->avail == v->tail) {                                                                        \
    ...
    vector_type* prefix##erase_range##suffix(struct struct_name* v, vector_type* begin, vector_type* end) {     \
        ...
        return v->avail -= diff;                                                                         \
                                                                                                         ...
                                                                                                         \
    vector_type* prefix##begin##suffix(const struct struct_name* v) { return v->head; }                         \
                                                                                                         \
    vector_type* prefix##end##suffix(const struct struct_name* v) { return v->avail; }                          \
                                                                                                         \
    void prefix##autogrow##suffix(struct struct_name* v) {                                                      \
        ...
        v->tail = v->head + n_size;                                                                      \
                                                                                                         ...
                                                                                                         \
    size_t prefix##size##suffix(const struct struct_name* v) { return v->avail - v->head; }                     \
                                                                                                         \
    size_t prefix##capacity##suffix(const struct struct_name* v) { return v->tail - v->head; }                  \
                                                                                                         \
    vector_type prefix##at##suffix(const struct struct_name* v, size_t n) { return *(v->head + n); }            \
                                                                                                         \
    void prefix##resize##suffix(struct struct_name* v, size_t n) {                                              \
        size_t old_sz = prefix##size##suffix(v);                                                         \
        if(n > old_sz) {                                                                                 \
    ...
    void prefix##shrink##suffix(struct struct_name* v, size_t n) {                                              \
        ...
        v->avail -= (prefix##size##suffix(v) - n);                                                       \
                                                                                                         ...
                                                                                                         \
    void prefix##clear##suffix(struct struct_name* v) { v->avail = v->head; }                                   \
                                                                                                         \
    void prefix##deinit##suffix(struct struct_name* v) { cstl_free(v->head); }                                  \
                                                                                                         \
    void prefix##destroy##suffix(struct struct_name* v) {                                                       \
